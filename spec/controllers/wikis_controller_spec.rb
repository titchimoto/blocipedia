...
RSpec.describe WikisController, type: :controller do
  ...
  context "standard user doing CRUD actions on things they own" do
    before do
      user = User.create!(email: "user1@example.org", password: "very-secret", role: 0)
      user.confirm
      sign_in user
    end
  ...
  context "admin user doing CRUD actions on things they don't own" do
    before do
      user = User.create!(email: "user2@example.org", password: "password")
      user.confirm
      user.admin!
      sign_in user
    end
